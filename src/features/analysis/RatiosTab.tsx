  ...
  return (
    <div>
      <div className="field-hint" style={{ margin: '0 0 16px' }}>
        คำนวณจากข้อมูลกระแสเงินสด/รายได้ {figures.months} เดือนล่าสุด และยอดคงเหลือ ณ วันนี้ (งบดุล) —{' '}
        {figures.takeHomeIsAfterTax
          ? 'รายได้สุทธิ (take-home) หักภาษีจริงแล้ว (ประเมินจากรายได้ 12 เดือนล่าสุดผ่านเครื่องมือคำนวณภาษี ปีภาษีล่าสุดที่ตั้งค่าไว้ในหน้า "ภาษี")'
          : 'รายได้สุทธิ (take-home) ยังไม่หักภาษี เพราะยังไม่มีการตั้งค่าภาษีในหน้า "ภาษี" — DSR จะดูดีกว่าความจริงเล็กน้อยจนกว่าจะตั้งค่า'}
      </div>
