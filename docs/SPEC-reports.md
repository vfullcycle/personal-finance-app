...
**งบกระแสเงินสด** (`buildCashFlowStatement`) — จาก legs ชุดเดียวกัน แยก 8 บรรทัด: รายรับ / รายจ่ายคงที่ / รายจ่ายแปรผัน / รายจ่ายไม่ระบุถัง (`cashflow_class is null`) / เงินออม-ลงทุน (debit leg บน asset ที่ `cashflow_class=savings`) / **ถอนเงินออม-ลงทุน** (credit leg บน asset ที่ `cashflow_class=savings` — v1.1) / เงินต้นผ่อนหนี้ (debit leg บน liability ที่ `subtype=loan`) / **เงินกู้ใหม่ที่รับเข้ามา** (credit leg บน liability ที่ `subtype=loan` — v1.1) กระแสเงินสดสุทธิ = รายได้สุทธิ − เงินออม-ลงทุน − เงินต้นผ่อนหนี้ + ถอนเงินออม-ลงทุน + เงินกู้ใหม่ที่รับเข้ามา มี callout เทียบกับรายได้สุทธิให้เห็นส่วนต่างชัด (ตรง REQUIREMENTS ข้อ 2)
